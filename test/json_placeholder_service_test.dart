...
void main() {
  test('it must return an TodoModel list', () async {
    final client = IHttpClientMock();
    when(() => client.get(any())).thenAnswer((_) async => jsonDecode(jsonData));
  ...
  test('it must return the first title value of the list', () async {
    final client = IHttpClientMock();
    when(() => client.get(any())).thenAnswer((_) async => jsonDecode(jsonData));
